...
/***/ "./src/controller/CreateForm/CreateForm.ts":
/*!*************************************************!*\
  !*** ./src/controller/CreateForm/CreateForm.ts ***!
  \*************************************************/
/*! no static exports found */
...
class CreateForm {
    ...
    setAttributesForTextInput(attributesTemplate) {
        const attributes = Object.assign({}, attributesTemplate);
        attributes.type = 'text';
        const CUSTOM_INPUT = this.createCustomInput(attributes);
        return CUSTOM_INPUT;
    }
    setAttributesForRunnersInput(attributesTemplate, id, position) {
        const attributes = Object.assign({}, attributesTemplate);
        attributes.id = id;
        attributes.type = 'number';
...
/***/ "./src/controller/PanelChangeHandler/PanelChangeHandler.ts":
/*!*****************************************************************!*\
  !*** ./src/controller/PanelChangeHandler/PanelChangeHandler.ts ***!
  \*****************************************************************/
/*! no static exports found */
...
exports.default = PanelChangeHandler;
...
Object.defineProperty(exports, "__esModule", { value: true });
const PanelChangeHandler_1 = __webpack_require__(/*! ./PanelChangeHandler/PanelChangeHandler */ "./src/controller/PanelChangeHandler/PanelChangeHandler.ts");
const CreateForm_1 = __webpack_require__(/*! ./CreateForm/CreateForm */ "./src/controller/CreateForm/CreateForm.ts");
/* eslint-enable */
class Controller {
    constructor(model, view) {
        this.handler = new PanelChangeHandler_1.default(this);
        const controller = this;
        this.model = model;
        this.view = view;
        this.view.controller = controller;
        this.model.controller = controller;
        this.render = new CreateForm_1.default(this.handler, this);
    ...
    setRunnerPosition(obj) {
        ...
        const input = root.querySelector(`#runners-${index}`);
        const range = root.querySelector('.slider__range');
    ...
    getFullConfiguration() {
        const CONFIGURATION_COPY = Object.assign({}, this.model.configuration);
...
class Slider {
    constructor(configuration) {
        this.ModelConstructor = model_1.Model;
        this.ViewConstructor = view_1.default;
        this.ControllerConstructor = controller_1.default;
...
$(document).ready(function () {
    const slider = $('div').slider(model_1.uConfiguration);
...
exports.incompleteConfiguration = {
    id: '#slider',
};
...
/***/ "./src/view/Render/Element/Element.ts":
/*!********************************************!*\
  !*** ./src/view/Render/Element/Element.ts ***!
  \********************************************/
/*! no static exports found */
...
class Element {
    constructor() {
        this.onMoveProgress = (obj) => {
            ...
            const progress = parent.querySelector(`.slider__progress[data-pair="${siblingProgressNumber}"]`);
    ...
    positionFromEnd(obj) {
        const { size, position, } = obj;
        return ((size - position));
    }
    relativeRunnerPositionToPercents(obj) {
...
/***/ "./src/view/Render/Progress/Progress.ts":
/*!**********************************************!*\
  !*** ./src/view/Render/Progress/Progress.ts ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/view/Render/Range/Range.ts":
/*!****************************************!*\
  !*** ./src/view/Render/Range/Range.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Element_1 = __webpack_require__(/*! ../Element/Element */ "./src/view/Render/Element/Element.ts");
class Range extends Element_1.default {
    constructor(parent) {
        super();
        this.onElementClickHandler = (event) => {
            let range;
            if (!this.draggable) {
                this.draggable = this.parent.range.querySelector('.slider__runner');
                if (document.elementFromPoint(event.pageX, event.pageY).classList.contains('slider__runner') === false) {
                    ...
                    if (!this.parent.view.fetchModelProperty('vertical')) {
                        runnerSize = runners[0].offsetWidth;
                    ...
                    runners.forEach((runner, i) => {
                        let pos;
                        if (!this.parent.view.fetchModelProperty('vertical')) {
                            pos = parseInt(runner.style.left, 10);
                        }
                        else {
                            pos = parseInt(runner.style.top, 10);
                        }
    ...
    renderNewSlider(obj) {
        ...
        if (this.parent.view.controller.getModelProperty('stepsOn') === false)
            this.registerEventHandlers(NEW_SLIDER);
    ...
    renderElement(element, parentElement) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const Tooltip_1 = __webpack_require__(/*! ./Tooltip/Tooltip */ "./src/view/Render/Tooltip/Tooltip.ts");
const Runner_1 = __webpack_require__(/*! ./Runner/Runner */ "./src/view/Render/Runner/Runner.ts");
const Progress_1 = __webpack_require__(/*! ./Progress/Progress */ "./src/view/Render/Progress/Progress.ts");
const Scale_1 = __webpack_require__(/*! ./Scale/Scale */ "./src/view/Render/Scale/Scale.ts");
const Range_1 = __webpack_require__(/*! ./Range/Range */ "./src/view/Render/Range/Range.ts");
class Render {
    constructor(view) {
        this.runnersAr = [];
        ...
        const that = this;
        this.view = view;
        this.rangeClass = new Range_1.default(that);
        this.runnerClass = new Runner_1.default(that);
        this.tooltipClass = new Tooltip_1.default(that);
        this.progressClass = new Progress_1.default(that);
        this.scaleClass = new Scale_1.default(that);
    }
    getSliderSize(obj) {
    ...
    calculateBreakpoints(sliderProperties) {
        const { range, vertical } = sliderProperties;
    ...
    setElementPosition(obj) {
        const { element, position, axis, parent, } = obj;
        let { negative } = obj;
    ...
    getTemporaryRunnerRectangle(parent) {
    ...
    createSlider(obj) {
        ...
        if (this.view.fetchModelProperty('scaleOn'))
            this.scaleClass.createScales({ parentNode: ROOT_NODE, vertical });
        if (this.isResizing)
            this.isResizing = false;
        return undefined;
    }
    createElement(nodeName, className) {
...
/***/ "./src/view/Render/Runner/Runner.ts":
/*!******************************************!*\
  !*** ./src/view/Render/Runner/Runner.ts ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Element_1 = __webpack_require__(/*! ../Element/Element */ "./src/view/Render/Element/Element.ts");
class Runner extends Element_1.default {
    constructor(parent) {
        super();
        this.onRunnerMouseDownHandler = (event) => {
            // event.preventDefault();
        ...
        this.onRunnerMouseMoveHandler = (event) => {
        ...
        this.onRunnerMouseUpHandler = () => {
            if (this.parent.view.fetchModelProperty('tooltips') === true)
                this.onTooltipHide(this.draggable);
        ...
        this.onTooltipHide = (runner) => {
            const parent = runner.offsetParent;
            const tooltipSibling = parent.querySelector(`.slider__tooltip[data-runner-sibling="${runner.dataset.tooltipSibling}"]`);
            tooltipSibling.classList.remove('slider__tooltip--show');
        };
        this.onDragStartHandler = (e) => e.preventDefault();
        this.parent = parent;
    }
    getSliderControlPoints(obj) {
        const { vertical, parent, point, element, } = obj;
    ...
    onRunnersCollision(obj) {
        const { targetElement, pair, vertical, } = obj;
    ...
    preventSiblingRunnerCollision(obj) {
        const { runner, vertical, pos, } = obj;
    ...
    stepHandler(position, parent, element, vertical) {
        if (this.parent.view.fetchModelProperty('stepsOn')) {
    ...
    RenderSliderRunners(obj) {
        const { runners, slider, vertical, root, } = obj;
    ...
    setRunnersDataAttributes(root) {
        ...
        let pair = 1;
        if (elements[0].classList.contains('slider__runner')) {
            collection.forEach((target, index, array) => {
                const HTMLrunner = target;
...
/***/ "./src/view/Render/Scale/Scale.ts":
/*!****************************************!*\
  !*** ./src/view/Render/Scale/Scale.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Element_1 = __webpack_require__(/*! ../Element/Element */ "./src/view/Render/Element/Element.ts");
class Scale extends Element_1.default {
    constructor(parent) {
        super();
        this.onElementClickHandler = (event) => {
            let range;
            if (!this.draggable) {
                this.draggable = this.parent.range.querySelector('.slider__runner');
                if (document.elementFromPoint(event.pageX, event.pageY).classList.contains('slider__scale')) {
                    const scale = (event.target);
                    range = scale.parentNode.parentNode;
                    const runners = range.querySelectorAll('.slider__runner');
                    let runnerSize;
                    let click;
                    if (!this.parent.view.fetchModelProperty('vertical')) {
    ...
    createScales(obj) {
        ...
        breakpoints.forEach((breakpoint, index, array) => {
            const scale = this.createScale({ mods });
...
/***/ "./src/view/Render/Tooltip/Tooltip.ts":
/*!********************************************!*\
  !*** ./src/view/Render/Tooltip/Tooltip.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const Element_1 = __webpack_require__(/*! ../Element/Element */ "./src/view/Render/Element/Element.ts");
class Tooltip extends Element_1.default {
    constructor(parent) {
        super();
        this.parent = parent;
    }
...
const Render_1 = __webpack_require__(/*! ./Render/Render */ "./src/view/Render/Render.ts");
class View {
    constructor() {
        this.handlers = {};
        const view = this;
        this.render = new Render_1.default(view);
    }
