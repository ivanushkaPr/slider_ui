...
class View {
    ...
    createSlider(obj) {
        ...
        let oddOrEven;
        runners.forEach((runnerPosition, index, array) => {
    ...
    setDataAttr(elements) {
        ...
        else if (elements[0].classList.contains('slider__tooltip')) {
    ...
    onRunnersCollision(obj) {
        const { targetElement, selector, nextPosition, vertical, } = obj;
    ...
    onMoveElementAtPoint(obj) {
        ...
        if (!vertical) {
            ...
            const runnerPosition = this.fetchModelProperty('stepsOn') === true
            ...
            const tooltipSibling = parent.querySelector(`.slider__tooltip[data-runner-sibling="${element.dataset.tooltipSibling}"]`);
