...
class View {
    ...
    createAndSetElementPosition(obj) {
        const { position, vertical, callback, parent, } = obj;
    ...
    createSlider(obj) {
        ...
        runners.forEach((runnerPosition, index) => {
